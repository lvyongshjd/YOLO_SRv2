...
if __name__ == "__main__":
    ...
    #----------------------------------------------------------------------------------------------------------------------------#
    #model_path      = '/media/glint/本地磁盘/yolov4-tiny-pytorch-master/logs1/last_epoch_weights.pth'
    model_path      = 'model_data/yolov4_tiny_weights_coco.pth'
    #model_path = ''
    #model_path='logs1/last_epoch_weights.pth'
    #------------------------------------------------------#
    #   input_shape     输入的shape大小，一定要是32的倍数
    #------------------------------------------------------#
    input_shape     = [512, 512]
    val_input_shape = [512, 512]
    #-------------------------------#
    #   所使用的注意力机制的类型
    #   phi = 0为不使用注意力机制
    #   phi = 1为SE
    ...
    if True:
        ...
        val_dataset     = YoloDataset(val_lines, val_input_shape, num_classes, epoch_length = UnFreeze_Epoch, \
